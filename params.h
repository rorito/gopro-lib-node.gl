...
int ngli_params_set(void *logger, uint8_t *base_ptr, const struct node_param *par, va_list *ap);
int ngli_params_set_constructors(void *logger, uint8_t *base_ptr, const struct node_param *params, va_list *ap);
int ngli_params_set_defaults(void *logger, uint8_t *base_ptr, const struct node_param *params);
int ngli_params_add(void *logger, uint8_t *base_ptr, const struct node_param *par, int nb_elems, void *elems);
